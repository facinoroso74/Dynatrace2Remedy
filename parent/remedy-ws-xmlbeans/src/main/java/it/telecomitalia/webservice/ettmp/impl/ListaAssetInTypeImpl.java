 ...
 */
public class ListaAssetInTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements it.telecomitalia.webservice.ettmp.ListaAssetInType
{
    private static final long serialVersionUID = 1L;
    
    public ListaAssetInTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
